...
const expenseTwo = store.dispatch(addExpense({ description:'Coffee', amount:300, createdAt: 15000}));
const expenseThree = store.dispatch(addExpense({ description:'Lunch', amount:500, createdAt: 5000}));
